...
let skillPercentage =
skill.getElementsByClassName("skills__number")[0].innerHTML;
let percentageBar = skill.getElementsByClassName("skills__percentage");
percentageBar[0].style.width = skillPercentage;
});
